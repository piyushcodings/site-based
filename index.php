...
<body class="vertical-layout" style="background-color:00000;" data-color="background-color:00000;">
		...
		<div class="col-md-8">
			<div class="card">
				<div class="card-body text-center">
					<h4 class="mb-2"><strong>𝗔𝗦𝗧𝗥𝗢 𝗖𝗛𝗘𝗖𝗞𝗘𝗥</strong></h4>
					...
					<button class="btn btn-stop btn-glow btn-bg-gradient-x-red-pink text-white" style="width: 49%; float: right;"><i class="fa fa-stop"></i></button>
				</div>
			</div>
		</div>
<div class="col-md-4">
...
<h5>CHARGE<span class="badge badge-success float-right charge">0</span></h5><hr>
...
if(total > 10000000000000000000000000000000000){
  Swal.fire({title: 'No more than 10000000000000000000000000000000000 cards!!', icon: 'warning', showConfirmButton: false, toast: true, position: 'top-end', timer: 3000});
  return false;
}
...
var callBack = $.ajax({
	url: 'astro api.php?lista=' + data,
	success: function(retorno){
		if(retorno.indexOf("ᴀꜱᴛʀᴏ ᴄᴠᴠ") >= 0){
			...
			else if(retorno.indexOf("ᴀꜱᴛʀᴏ ʟɪᴠᴇ") >= 0){
